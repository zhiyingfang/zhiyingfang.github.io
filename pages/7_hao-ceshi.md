     ...
     <div id="kuang2"><!-- group -->
      <div id="bg1"><!-- column -->
       ...
       <div id="kuang4"><!-- 第四行 -->
        ...
        <a id="fangge4" href="http://www.thefwa.com" target="_blank"><!-- content --><h2 id="wangzhi2">FWA</h2><p id="shuoming2">著名的互动多媒体网站收录平台，展示最优秀、最前沿的网络媒体艺术设计作品。</p></a>
        <div id="shuxian4"><!-- image -->
         <img class="block" src="/assets/hao/line.png" alt="" width="1" height="80"/>
        </div>
        <a id="fangge5" href="待补充" target="_blank"><!-- content --><h2 id="wangzhi2">待补充</h2><p id="shuoming2">待补充</p></a>
...
<div id="nav">
  <div class="float-right">
    ...
    <a href="#CC0tuku">CC0图库</a>
    <a href="#gaoqingtuku">高清图库</a>
    <a href="#shejikuzhan">设计酷站</a>
    ...
    <a href="#shujuyanjiu">数据研究</a>
    <a href="#wenzhangjiaocheng">文章教程</a>  
    <a href="#tubiaologo">图标LOGO</a>  
    <a href="#pszhuanqu">PS专区</a>   
    <a href="#baozhuangsheji">包装设计</a>  
    <a href="#manhuachatu">漫画插图</a>   
    <a href="#daimatexiao">代码特效</a>  
    <a href="#shejiluntan">设计论坛</a>  
    <a href="#shejituandui">设计团队</a>  
    <a href="#qitawangzhan">其他网站</a>  
  </div>
</div>
