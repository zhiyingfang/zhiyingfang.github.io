(function(){
    var Main = {
        ...
        showModel: function(){
            ...
            var effectModel = '<li class="e_item"><div class="imgWrapper"><img src="/assets/tools/alloyphoto/{pic}.png" alt="" />{effect}</div></li>';
            var html = '<li class="e_item"><div class="imgWrapper"><img src="/assets/tools/alloyphoto/e1.jpg" alt="" />原图</div></li>';
